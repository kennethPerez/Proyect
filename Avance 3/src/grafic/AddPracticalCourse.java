...
public class AddPracticalCourse extends javax.swing.JFrame {

    /**
     * Creates new form AddStudents
     */
    public AddPracticalCourse() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(newname.getText().equals("")){
            ...
            PracticalCourse Ps = new PracticalCourse(mat,sys, name, credits, sem);
            Ps.insert();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPracticalCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPracticalCourse().setVisible(true);
            }
        });
    }
